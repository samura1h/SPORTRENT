// =============================================================
//  payment.js — Логіка сторінки "Оплата"
//  Завдання 1: do..while для рендеру замовлення, if-else стилі
//  Завдання 2: Toggle кроків, вибір методу оплати, for обробники
//  Завдання 3: Валідація картки в реальному часі, DOM-оновлення
// =============================================================
