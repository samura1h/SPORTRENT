// =============================================================
//  equipment.js — Логіка сторінки "Обладнання"
//  Завдання 1: DOM + do..while + querySelectorAll + if-else
//  Завдання 2: Обробка подій, toggle, hover
//  Завдання 3: Модальне вікно з вибором дат, валідація
// =============================================================
